    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                // ===== NUEVO: Seguridad por roles =====
                // Solo ROLE_DESCARGAR puede descargar guías
                .requestMatchers("/api/guias/**/descargar").hasRole("DESCARGAR")
                
                // ROLE_ADMIN puede hacer TODO lo demás
